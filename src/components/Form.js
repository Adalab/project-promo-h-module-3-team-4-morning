      ...
      <section className="form">
        <form>
          ...
          <Collapsible title="Rellena" icon={faKeyboard} id="C2" collapsibleId={this.state.collapsibleId} handleCollapsibleAction={this.handleCollapsibleAction}>
            <Fill name={this.props.name} job={this.props.job} email={this.props.email} phone={this.props.phone} linkedin={this.props.linkedin} github={this.props.github} handleInputChange={this.props.handleInputChange} photo={this.props.photo} fileSelectedHandler={this.props.fileSelectedHandler} />
          </Collapsible>
