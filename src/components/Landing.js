  ...
  return (
    <div className="landingContainer">
      <main className="landing">
        <img className="landing__image" src="./assets/images/logoheader.svg" alt="Logo del Header" />
        <h1 className="landing__title">Crea tu tarjeta de visita</h1>
        <h2 className="landing__text">Crea mejores contactos profesionales de forma fácil y cómoda</h2>
