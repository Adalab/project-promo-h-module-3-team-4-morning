          ...
          <footer className="preview__display--footer menu">
            <ul className="menu__list">
              <Icon
                href={`tel:+${phone}`}
                icon={faMobileAlt}
                classLi={`menu__items--phone ${phone ? '' : 'filter'}`}
              />
              <Icon
                href={`mailto:${email}`}
                icon={faEnvelope}
                classLi={`menu__items--email ${email ? '' : 'filter'}`}
              />
              <Icon
                href={`https://www.linkedin.com/in/${linkedin}`}
                icon={faLinkedinIn}
                classLi={`menu__items--linkedin ${linkedin ? '' : 'filter'}`}
              />
              <Icon
                href={`https://www.github.com/${github}`}
                icon={faGithubAlt}
                classLi={`menu__items--github ${github ? '' : 'filter'}`}
              />
            </ul>
          </footer>
        </article>
